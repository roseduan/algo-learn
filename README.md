...
| 题号 |                           题目名称                           |                           解题代码                           |        难度         |
| :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :-----------------: |
| 206  | [反转链表](https://leetcode-cn.com/problems/reverse-linked-list/) | [Java](https://github.com/roseduan/algo-learn/blob/master/java/datastructure/linkedlist/leetcode/ReverseLinkedList.java)、Python、Go |        简单         |
| 160  | [相交链表](https://leetcode-cn.com/problems/intersection-of-two-linked-lists/) |                       Java、Python、Go                       |        简单         |
| 141  | [环形链表](https://leetcode-cn.com/problems/linked-list-cycle/) |                       Java、Python、Go                       |        简单         |
|  21  | [合并两个有序链表](https://leetcode-cn.com/problems/merge-two-sorted-lists/) |                       Java、Python、Go                       |        简单         |
| 142  |                          环形链表II                          |                       Java、Python、Go                       |        中等         |
|  19  | [删除链表倒数第 N 个节点](https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list/) |                       Java、Python、Go                       |        中等         |
|      |                           回文链表                           |                       Java、Python、Go                       |        中等         |
|      |                       两两交换链表节点                       |                       Java、Python、Go                       |        中等         |
|      |                           奇偶链表                           |                       Java、Python、Go                       |        中等         |
|      |                           两数相加                           |                       Java、Python、Go                       |        中等         |
|      |                       k 个一组翻转链表                       |                       Java、Python、Go                       |        困难         |
|  #   |               ################################               |                     ###################                      | ################### |
...
| 题号 |   题目名称   |                           解题代码                           | 难度 |
| :--: | :----------: | :----------------------------------------------------------: | :--: |
|      |   括号匹配   | Java、Python、[Go](https://github.com/roseduan/algo-learn/blob/master/go/stack/leetcode/valid_parentheses.go) | 简单 |
|      |    最小栈    | Java、Python、[Go](https://github.com/roseduan/algo-learn/blob/master/go/stack/leetcode/min_stack.go) | 简单 |
|      | 用栈实现队列 |                       Java、Python、Go                       | 简单 |
...
| 题号 |     题目名称     |                           解题代码                           | 难度 |
| :--: | :--------------: | :----------------------------------------------------------: | :--: |
|      |  使用队列实现栈  |                       Java、Python、Go                       | 简单 |
|      | 设计循环双端队列 | [Java](https://github.com/roseduan/algo-learn/blob/master/java/datastructure/queue/leetcode/MyCircularDeque.java)、Python、Go | 简单 |
|      | 滑动窗口的最大值 | [Java](https://github.com/roseduan/algo-learn/blob/master/java/datastructure/queue/leetcode/SlidingWindowMaximum.java)、Python、[Go](https://github.com/roseduan/algo-learn/blob/master/go/queue/leetcode/sliding_window_maximum.go) | 困难 |
